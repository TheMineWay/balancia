...
import { GET_MY_BUDGET_SEGMENT_IMPUTATIONS_QUERY_KEY } from "@fts/finances/budgets/my-budget-segment-transactions/api/use-my-budget-segment-imputations-list.query";
	...
	return useMutation({
		...
		onSuccess: ({ segmentId }) => {
			queryClient.invalidateQueries({
				queryKey: GET_MY_BUDGET_SEGMENT_IMPUTATIONS_QUERY_KEY({ segmentId }),
			});
		},
	});
};
