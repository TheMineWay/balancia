...
export const USE_BUDGET_BY_ID_QUERY_KEY: ParametrizedQueryKey<{
...
export const useBudgetByIdQuery = (budgetId: BudgetModel["id"]) => {
	...
	return useQuery({
		...
		queryKey: USE_BUDGET_BY_ID_QUERY_KEY({ budgetId }),
	});
};
