...
import { CategoriesTable } from "@fts/finances/categories/components/categories.table";
import { useMyCategoriesQuery } from "@fts/finances/my-categories/api/use-my-categories.query";
import { useMyCategoryDeleteByIdMutation } from "@fts/finances/my-categories/api/use-my-category-delete-by-id.mutation";
import { MyCategoryCreateManager } from "@fts/finances/my-categories/components/manager/my-category-create-manager";
import { MyCategoryUpdateManager } from "@fts/finances/my-categories/components/manager/my-category-update-manager";
