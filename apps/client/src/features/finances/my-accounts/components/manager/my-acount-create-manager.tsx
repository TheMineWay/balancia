import { AccountForm } from "@fts/finances/accounts/components/form/account.form";
import { useMyAccountCreateMutation } from "@fts/finances/my-accounts/api/use-my-account-create.mutation";
