...
CREATE INDEX account_category_expenses_stats_accountId_date_idx ON finances.account_category_expenses_stats ("accountId","date");--> statement-breakpoint
CREATE INDEX account_category_expenses_stats_categoryId_idx ON finances.account_category_expenses_stats ("categoryId");--> statement-breakpoint
...
CREATE INDEX account_stats_userId_date_idx ON finances.account_monthly_stats ("userId","date");--> statement-breakpoint
...
CREATE INDEX account_stats_userId_idx ON finances.account_stats ("userId");
