...
CREATE UNIQUE INDEX account_stats_accountId_date_idx ON finances.account_monthly_stats ("accountId","date");--> statement-breakpoint
...
CREATE UNIQUE INDEX account_stats_accountId_idx ON "finances"."account_stats" ("accountId");--> statement-breakpoint
